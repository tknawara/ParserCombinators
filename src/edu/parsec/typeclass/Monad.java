...
public interface Monad<T, MClass extends Monad<?, MClass>> {
     ...
     */
    <B> Monad<B, MClass> map(Function<T, B> f);
     ...
     */
    <B> Monad<B, MClass> flatMap(Function<T, Monad<B, MClass>> f);
     ...
     * {@code other} action
     */
    default <B> Monad<B, MClass> then(Monad<B, MClass> other) {
     ...
     */
    default <C> Monad<C, MClass> apply(Monad<Function<T, C>, MClass> fM) {
     ...
     * @return the result of the function lifted to the monadic world
     */
    default <B, C> Monad<C, MClass> liftM2(BiFunction<T, B, C> f, Monad<B, MClass> paramTwo) {
     ...
     * @return m t b
     */
    default <A, B> Monad<IList<B>, MClass> mapM(final Function<A, Monad<B, MClass>> f, final IList<A> list) {
    ...
    default <A, B> Monad<IList<B>, MClass> forM(final IList<A> list, final Function<A, Monad<B, MClass>> f) {
